...
public class Toast extends JWindow {
    ...
    private final Insets insets = new Insets(6, 12, 6, 12);
    ...
    public void paint(Graphics g) {
        ...
        g2.drawString(message, insets.left * 2, fm.getAscent() + insets.top);
        // restore
    ...
    private Dimension getStringSize(Font font, boolean isAntiAliased,
        ...
        int width = (int) bounds.getWidth() + 4 * insets.left;
